Feature: User Authentication
    ...
    Scenario: Login with valid credentials via API
        Given I have a registered user with email "root@kashmiridryfruits.com" and password "root123"
        When I login via API with email "root@kashmiridryfruits.com" and password "root123"
    ...
    Scenario: Login with valid credentials via UI
        ...
        When I enter email "root@kashmiridryfruits.com" and password "root123"
